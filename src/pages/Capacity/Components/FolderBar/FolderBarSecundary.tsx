  ...
  return (
    <div className="folder-bar">
      <div className="folder-container">
        <a href="capacitacao/playlist/java-pratica" className="folder-card">
        ...
        <a href="capacitacao/playlist/springBoot-iniciante" className="folder-card">
        ...
        <a href="capacitacao/playlist/springBoot-angular" className="folder-card">
          <img src={springbootAngularImg} alt="Logo da playlist de capacitação" />
          <span className="folder-title">Spring Boot + Angular</span>
        </a>
        <a href="capacitacao/playlist/fullstack-springBoot" className="folder-card">
